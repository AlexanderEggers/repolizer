...
constructor(networkControllerClass: Class<out NetworkController> = DefaultNetworkController::class.java,
            httpClient: OkHttpClient?,
            baseUrl: String,
            gson: Gson = Gson()) : AdapterFactory<RetrofitNetworkAdapter> {
